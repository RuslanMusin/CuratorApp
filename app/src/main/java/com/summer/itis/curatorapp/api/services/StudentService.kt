...
interface StudentService {
    ...
    fun findSuggestions(
        @Path(value = "student_id") id: String
    ): Single<Result<List<Suggestion>>>

    @GET("students/{student_id}/suggestions/{suggestion_id}")
    fun findSuggestion(
        @Path(value = "student_id") curatorId: String,
    ...
    fun findStepMaterials(
        @Path(value = "student_id") curatorId: String,
        @Path(value = "work_id") workId: String,
        @Path(value = "step_id") stepId: String
    ): Single<Result<List<String>>>
